...
func TestAmalgomate(t *testing.T) {
	...
	for i, currCase := range []struct {
		...
		err = ioutil.WriteFile(confPath, []byte(getConfigString(t, parser.Config{
			Pkgs: map[string]parser.SrcPkg{
				"testmain": {
					MainPkg: importPath,
				},
			},
...
func getConfigString(t *testing.T, config parser.Config) string {
