...
func TestImage(t *testing.T) {
	containers := []*container{
		{RawName: "full-spec", RawImage: "test/image-a:1.0"},
		{RawName: "without-repo", RawImage: "image-b:latest"},
		{RawName: "without-tag", RawImage: "test/image-c"},
		{RawName: "image-only", RawImage: "image-d"},
		{RawName: "private-registry", RawImage: "localhost:5000/foo/image-e:2.0"},
		{RawName: "private-registry-without-tag", RawImage: "localhost:5000/foo/image-e"},
		{RawName: "digest", RawImage: "localhost:5000/foo/image-f@sha256:xxx"},
	}
