...
* Optional Unison sync for Docker for Mac to improve performance.
  For more information, see [Docker for Mac with Unison sync](https://github.com/sniperkit/snk.fork.michaelsauter-crane#docker-for-mac-with-unison-sync).
...
Please see the [releases](https://github.com/sniperkit/snk.fork.michaelsauter-crane/releases).
